...
object Scans:
  ...
  private[consequences] val ModifierWords: Set[String] =
    Set
  ...
  private[consequences] val DeclKeywords: Set[String] =
    Set("def", "val", "var", "type", "class", "trait", "object", "enum", "given")

  private[consequences] val NonOperandWords: Set[String] =
    Set
  ...
  private[consequences] def isSymbolicOperator(text: String): Boolean =
  ...
  private[consequences] def hasBlankLineBetween
