...
object Scans:
  ...
  private[consequent] val ModifierWords: Set[String] =
    Set
  ...
  private[consequent] val DeclKeywords: Set[String] =
    Set("def", "val", "var", "type", "class", "trait", "object", "enum", "given")

  private[consequent] val NonOperandWords: Set[String] =
    Set
  ...
  private[consequent] def isSymbolicOperator(text: String): Boolean =
  ...
  private[consequent] def hasBlankLineBetween
